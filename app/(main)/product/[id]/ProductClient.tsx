                        ...
                        return (
                          <button key={level} type="button"
                            ...
                            style={{ flex:1, padding:'7px 2px', borderRadius:8, cursor:'pointer',
                              ...
                              lineHeight:1.3, transition:'all .12s', whiteSpace:'pre-line', textAlign:'center' }}>
            ...
            <div style={{ borderTop:'1px solid #F0F0F0', paddingTop:14, textAlign:'left' }}>
              <button type="button" onClick={() => setReviewPolicyOpen(o => !o)}
                ...
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#999" strokeWidth="2"
                  strokeLinecap="round" strokeLinejoin="round"
                  style={{ transform: reviewPolicyOpen ? 'rotate(180deg)' : 'none', transition:'transform .2s' }}>
                  <polyline points="6 9 12 15 18 9"/>
                </svg>
              </button>
              <p style={{ fontSize:12, color:'#999', lineHeight:1.6, margin:'8px 0 0', textAlign:'left' }}>
                상품과 관련 없는 사진이나 내용, 동일 문자 반복 등 부적합한 내용은 삭제될 수 있습니다.
              </p>
              {reviewPolicyOpen && (
                <ul style={{ fontSize:12, color:'#888', lineHeight:1.8, margin:'8px 0 0', padding:0, listStyle:'none', textAlign:'left' }}>
