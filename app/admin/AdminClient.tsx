                    ...
                    <table className="adm-table adm-table-center">
                      <thead>
                        <tr>
                          ...
                          <th style={{ width:120 }}>주문번호</th><th style={{ width:104 }}>주문일시</th><th style={{ width:84 }}>수령인</th>
                          <th style={{ textAlign:'left', width:'auto' }}><span style={{ display:'inline-block', width:180, maxWidth:'100%', textAlign:'center' }}>상품</span></th>
                          <th style={{ width:96 }}>금액</th><th style={{ width:88 }}>상태</th><th style={{ width:130 }}>송장번호</th><th style={{ width:150 }}>관리</th>
                        </tr>
                      </thead>
                      <tbody>
